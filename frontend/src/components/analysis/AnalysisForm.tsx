...
export function AnalysisForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <h3 className="mt-3 text-2xl font-semibold text-slate-900">{t('analysis.targetHandle')}</h3>
      <p className="text-sm text-slate-500">{t('analysis.pullRealtime')}</p>

      <div className="mt-5 space-y-3">
        <div>
          <label className="text-sm text-slate-700">{t('analysis.instagramUsername')}</label>
          <div className="mt-2 flex gap-2">
            <span className="flex items-center rounded-2xl border border-slate-200 bg-slate-50 px-4 text-slate-500">@</span>
            <input
              type="text"
              {...register('username')}
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
        ...
        <button
          ...
          className="flex w-full items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 hover:bg-slate-100 transition"
        >
        ...
        <button
          ...
          className="flex w-full items-center justify-center rounded-2xl bg-primary px-4 py-3 text-lg font-semibold text-white transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60"
        >
          {mutation.isPending ? (
            <>
